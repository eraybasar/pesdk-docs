...
override fun onActivityResult(requestCode: Int, resultCode: Int, data: android.content.Intent) {
    ...
    if (resultCode == RESULT_OK && requestCode == EDITOR_RESULT) {
        ...
        val writer = IMGLYFileWriter(settingsList)
...
---
``````kotlin
val settingsList = createInitialPesdkSettingsList()

val PESDK_RESULT = 1

// Set input image
settingsList.getSettingsModel(LoadSettings::class.java).source = inputImage
