...
For details on the JSON structure you can [download]({{ site.baseurl }}/assets/downloads/serialization/schema-1.0.2.json){: download="schema-1.0.2.json" } our schema.
