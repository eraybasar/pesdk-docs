...
to the `options` object passed to the UI:
  ...
  * `editor` Object
    ...
    * `controlsOptions` Object - Objects passed to the controls. See [the documentation](http://static.photoeditorsdk.com/docs/ios/PhotoEditorSDK.UI.NightReact.Controls.html) for available controls and their options.
