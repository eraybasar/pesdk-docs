...
<%=md_image("/assets/images/documentation/ios/photoroll-library.png") %>
...
<%=md_image("/assets/images/documentation/ios/photoroll-photo.png") %>
...
<%=md_image("/assets/images/documentation/ios/photoroll-searchsuggestion.png") %>
